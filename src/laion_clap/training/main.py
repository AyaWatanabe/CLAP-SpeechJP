...
def main():
    ...
    model, model_cfg = create_model(
        ...
        separated_feature_predictor=args.separated_feature_predictor
    )
    ...
    model = torch.nn.DataParallel(model, device_ids=list(int(g) for g in num_gpu.split(",")))
